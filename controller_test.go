...
import (
	...
	kelefstis "github.com/endocode/kelefstis/pkg/apis/kelefstis/v1alpha1"
	"github.com/endocode/kelefstis/pkg/client/clientset/versioned/fake"
...
func newFoo(name string, replicas *int32) *kelefstis.Foo {
	return &kelefstis.Foo{
		TypeMeta: metav1.TypeMeta{APIVersion: kelefstis.SchemeGroupVersion.String()},
		ObjectMeta: metav1.ObjectMeta{
			Name:      name,
			Namespace: metav1.NamespaceDefault,
		},
		Spec: kelefstis.FooSpec{
...
func (f *fixture) newController() (*Controller, informers.SharedInformerFactory, kubeinformers.SharedInformerFactory) {
	...
	c := NewController(f.kubeclient, f.client,
		...
		i.Samplecontroller().V1alpha1().RuleCheckers())
...
func (f *fixture) expectUpdateFooStatusAction(foo *kelefstis.Foo) {
...
func getKey(foo *kelefstis.Foo, t *testing.T) string {
