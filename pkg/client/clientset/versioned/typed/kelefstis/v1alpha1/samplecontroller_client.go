...
import (
	...
	"github.com/endocode/kelefstis/pkg/client/clientset/versioned/scheme"
...
// SamplecontrollerV1alpha1Client is used to interact with features provided by the kelefstis.k8s.io group.
type SamplecontrollerV1alpha1Client struct {
	restClient rest.Interface
}

func (c *SamplecontrollerV1alpha1Client) RuleCheckers(namespace string) RuleCheckerInterface {
	return newRuleCheckers(c, namespace)
}
